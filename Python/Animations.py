...
class PixelArtEditor:
    ...
    def animate(self):
        if self.frame_index < len(self.color_sequence):
            ...
            # Reset frame index to 0 to start the animation again
            self.frame_index = 0
            # Call animate again to continue the animation
            self.animate()
    ...
    def draw_man2(self, x, y,color):
        ...
        self.draw_circle(x - 1, y + 2, color)
        self.draw_circle(x + 1, y + 2, color)
        self.draw_circle(x - 1, y + 3, color)
        self.draw_circle(x + 2, y + 3, color)

        # Legs
        self.draw_circle(x , y + 4, color)
        self.draw_circle(x - 1, y + 5, color)
        self.draw_circle(x - 1, y + 6, color)
        self.draw_circle(x + 1, y + 5, color)
        self.draw_circle(x + 2, y + 6, color)

    def draw_man3(self, x, y,color):
        # Head
        self.draw_circle(x, y, "red")
        ...
        self.draw_circle(x + 1, y + 2, color)
        self.draw_circle(x - 1, y + 3, color)
        self.draw_circle(x + 2, y + 2, color)

        # Legs
        self.draw_circle(x, y + 4, color)
        self.draw_circle(x - 1, y + 5, color)
        self.draw_circle(x - 2, y + 6, color)
        self.draw_circle(x , y + 5, color)
        self.draw_circle(x , y + 6, color)

    def draw_man4(self, x, y,color):
        # Head
        self.draw_circle(x, y, "red")
    ...
    def draw_man5(self, x, y,color):
        ...
        self.draw_circle(x, y + 3, color)
        # Arms
        self.draw_circle(x - 1, y + 1, color)
        self.draw_circle(x - 2, y + 1, color)
        self.draw_circle(x - 2, y + 2, color)
        self.draw_circle(x + 1, y + 2, color)
        self.draw_circle(x + 2, y + 3, color)
        # Legs
        ...
        self.draw_circle(x + 1, y + 5, color)
        self.draw_circle(x + 2, y + 6, color)
        self.draw_circle(x + 3, y + 7, color)
        self.draw_circle(x , y + 5, color)
        self.draw_circle(x , y + 6, color)
        self.draw_circle(x, y + 7, color)

    def draw_man6(self, x, y,color):
        # Head
        self.draw_circle(x, y, "red")
